...
data class DarkColored( @SerializedName("svg") @Expose  var svg: String ,@SerializedName("png") @Expose  var png: String,  @SerializedName("currency_widget") @Expose  var currencyWidget: CurrencyWidgetModel,  @SerializedName("disabled") @Expose  var disabled: DisabledModel ):Serializable
...
data class LightMono( @SerializedName("svg") @Expose  var svg: String ,@SerializedName("png") @Expose  var png: String,  @SerializedName("currency_widget") @Expose  var currencyWidget: CurrencyWidgetModel,  @SerializedName("disabled") @Expose  var disabled: DisabledModel ):Serializable
