...
interface PaymentCardComplete {
    ...
    fun onPayCardCompleteAction(isCompleted: Boolean, paymentType: PaymentType, cardNumber: String?=null, expiryDate: String?=null, cvvNumber : String?=null,holderName:String?=null,  cardBrandString: String?=null , savedCardsModel :Any?=null)
