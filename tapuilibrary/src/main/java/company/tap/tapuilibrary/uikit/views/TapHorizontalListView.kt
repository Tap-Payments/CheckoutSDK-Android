...
class TapHorizontalListView (context: Context?, attrs: AttributeSet?) :
    ...
    private var tabLayout: LinearLayout
     ...
     */
    init {
        inflate(context, R.layout.tap_horizontal_list_view, this)
        tabLayout = findViewById(R.id.linear)
