...
object AppColorTheme {
    ...
    const val ControlCurrencyWidgetConfirmButtonBackgroundColor =
        "CurrencyWidget.confirmButton.backgroundColor"
    const val ControlCurrencyWidgetConfirmButtonCornerRadius =
        "CurrencyWidget.confirmButton.cornerRadius"
    const val ControlCurrencyWidgetConfirmButtonTitleFont = "CurrencyWidget.confirmButton.titleFont"
    const val ControlCurrencyWidgetConfirmButtonTitleFontColor =
        "CurrencyWidget.confirmButton.titleFontColor"
    ...
    const val ControlCurrencyWidgetCurrencyDropDownLabelColor =
        "CurrencyWidget.currencyDropDown.labelColor"
    const val ControlCurrencyWidgetCurrencyDropDownTintColorOfIcon =
     ...
     * loyality
     */
    const val LoyalityWidgetInvalidAmountBackgroundColor =
        "loyaltyView.amountView.invalidAmount.hintBackgroundColor"
    const val LoyalityWidgetInvalidAmountTextColor =
