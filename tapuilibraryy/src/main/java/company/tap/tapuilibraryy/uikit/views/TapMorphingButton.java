...
import company.tap.tapuilibraryy.uikit.animation.Morphing2Animation;
import company.tap.tapuilibraryy.uikit.utils.StrokeGradientDrawable;

public class TapMorphingButton extends AppCompatButton {
    ...
    public TapMorphingButton(Context context) {
        super(context);
        initView();
    }

    public TapMorphingButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public TapMorphingButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void morphWithAnimation(@NonNull final Params params) {
        ...
        Morphing2Animation.Params animationParams = Morphing2Animation.Params.create(this)
                ...
                .listener(new Morphing2Animation.Listener() {
                    @Override
        ...
        Morphing2Animation animation = new Morphing2Animation(animationParams);
        animation.start();
    }
    ...
    public static class Params {
        ...
        public Params animationListener(Morphing2Animation.Listener animationListener) {
