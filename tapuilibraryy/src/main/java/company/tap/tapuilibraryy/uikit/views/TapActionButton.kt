...
import company.tap.tapuilibraryy.uikit.utils.dp
import company.tap.tapuilibraryy.uikit.utils.getColorX
import company.tap.tapuilibraryy.uikit.utils.getDrawableX
import company.tap.tapuilibraryy.uikit.utils.sp

class TapActionButton @JvmOverloads constructor(
    context: Context,
    ...
    var fromBgColor: Int = getColorX(company.tap.tapuilibraryy.R.color.gray)
    ...
    var btnRadius = 100 * dp()

    var iconDrawable = getDrawableX(R.drawable.loader)
        set(value) {
            field = value
            setSizeIcon()
        }
    ...
    fun setUIState(uiState: UIState): Boolean {
        ...
        runAnimation(isReverse).apply {
            doOnEnd {
                this@TapActionButton.uiState = uiState
            }
        }
        return true
    }
    ...
    private fun runAnimation(isReverse: Boolean): AnimatorSet {
        ...
        return AnimatorSet().apply {
            ...
            doOnStart {
                this@TapActionButton.uiState = UIState.Animating
            }
            duration = 250L
            start()
