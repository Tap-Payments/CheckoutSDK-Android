...
import company.tap.tapuilibraryy.uikit.views.TapMorphingButton;

public class Morphing2Animation {
    ...
    public static class Params {
        ...
        public static Params create(@NonNull TapMorphingButton button) {
    ...
    public Morphing2Animation(@NonNull Params params) {
        mParams = params;
    }
